...
const PUBLIC_RAW_BUNDLE='https://raw.githubusercontent.com/980510linz/signwell.com/main/public-data.json';
const PUBLIC_RAW_INDEX='https://raw.githubusercontent.com/980510linz/signwell.com/main/articles/index.json';
const PUBLIC_RAW_BASE='https://raw.githubusercontent.com/980510linz/signwell.com/main/';
...
function swSeoPrimaryCanonical(){const f=(location.pathname.split('/').pop()||'index.html').toLowerCase();const m={"index.html":"https://980510linz.github.io/signwell.com/","topics.html":"https://980510linz.github.io/signwell.com/topics.html","about.html":"https://980510linz.github.io/signwell.com/about.html","share.html":"https://980510linz.github.io/signwell.com/share.html","newsletter.html":"https://980510linz.github.io/signwell.com/newsletter.html"};return m[f]||'https://980510linz.github.io/signwell.com/'}
...
function route(){
  ...
  const q=new URLSearchParams(location.search);if(q.has('article'))return{page:'article',slug:q.get('article')||''};if(h.startsWith('article/'))return{page:'article',slug:decodeURIComponent(h.slice(8))};
...
function softPrimaryRoute(url,page){
  ...
  try{
    const u=new URL(url,location.href);
    /* Cross-examination invariant: one HTML file owns one primary surface.
       Never spoof another pathname with pushState; otherwise the old bundle can
       render a stale clone (notably the pre-v24.22 topic corridor). */
...
/* ---------- boot ---------- */
(async()=>{
  window.SignWellErrors?.installGlobal?.({surface:'PUB',module:'public-runtime',homeUrl:'https://980510linz.github.io/signwell.com/'});
